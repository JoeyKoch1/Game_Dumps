...
A collection of game memory dumps and related data, currently focused on **Counter-Strike 2 (CS2)**.
...
This is for educational and research purposes only. Dumps may reflect only specific game versions/updates and can go stale when the game is patched.
